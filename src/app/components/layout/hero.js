export default function Hero(){
    return (<section>
      ...
      <div className="flex flex-col items-start w-full max-w-xl px-4 mx-auto lg:px-5 lg:max-w-screen-xl">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            <div>
              <p className="inline-block py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full ">
          ...
          <div className="flex flex-col gap-10 items-center md:flex-row">
            <a
              href="/"
              className="bg-gray-100 inline-flex items-center justify-center w-full h-12 px-6 mb-3 font-medium tracking-wide hover:bg-green-500 text-black transition duration-100 rounded shadow-lg md:w-auto md:mr-4 md:mb-0 bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none  hover:text-black"
            >
  ...
  <path d="M9.293 8.707 12.586 12l-3.293 3.293 1.414 1.414L15.414 12l-4.707-4.707-1.414 1.414z"/>
            ...
            <a href="/"
              className="inline-flex items-center font-semibold hover:text-green-700 text-gray-800 transition-colors duration-200 hover:text-deep-purple-accent-700"
            >Learn more
            </a>
          </div>
        </div>
